...
class ControllerCertificates extends Controller
{
    /**
    ...
    public function index(Certificates $certificates)
    {
        $data = $certificates->show(); 
        return view('certificates',  array('page' => $data['page'], 'header_footer' => $data['header_footer']));
    }
    /**
